...
<body style="background: url(https://sso.maxim-ic.com//app/sso/src/f01-bgstrip.png) 50% 0px repeat-y scroll rgb(239, 239, 239);">
                ...
                <h3 class="text-center">Single Sign On - Maxim Applications
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4"></div>
                                <div class="col-md-4">
                    <div id="pleaseWait">Active Directory login failed or SCM username not found.</div>
						</div>
                                <div class="col-md-4"></div>
                                </div>
                        </form>
