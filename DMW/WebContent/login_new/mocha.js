...
var MochaUI = new Class({
    ...
    options: {
        ...
        minWidth:          550,   // Minimum width of windows when resized

        maxWidth:          2500,  // Maximum width of windows when resized

        minHeight:         300,   // Minimum height of windows when resized

        maxHeight:         2000,  // Maximum height of windows when resized

        // Style options:

        headerHeight:      30,    // Height of window titlebar
        ...
        headerStartColor:  [0, 178, 169],  // Header gradient's top color - RGB

        headerStopColor:   [0, 178, 169],  // Header gradient's bottom color

        footerBgColor:     [246, 246, 246],  // Background color of the main canvas shape

        minimizeColor:     [255, 255, 255],  // Minimize button color

        maximizeColor:     [255, 255, 255],  // Maximize button color

        closeColor:        [255, 255, 255],  // Close button color
        ...
        mochaTopOffset:    40,    // Initial vertical spacing of each window
